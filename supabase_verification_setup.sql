...
-- Note: The Service Role Key (used in the API route and Admin routes) automatically bypasses RLS,
-- allowing the backend to read all verifications and download any certificate file.
